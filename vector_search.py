...
class VectorSearch:
    ...
    def create_dtc_embeddings(self, dtc_index: Dict) -> Dict:
        ...
        print("Creating embeddings for DTC codes...")
    ...
    def save_embeddings(self, filepath: str = "dtc_embeddings.json"):
    ...
    def load_embeddings(self, filepath: str = "dtc_embeddings.json"):
        ...
        if os.path.exists(filepath):
            ...
            print(f"Loaded embeddings for {len(self.dtc_embeddings)} DTC codes")
            return True
        else:
...
if __name__ == "__main__":
    ...
    for query in test_queries:
        print(f"\nQuery: '{query}'")
        results = vector_search.semantic_search(query, top_k=3)
